...
# Install core dependencies with specific CUDA index (Note file name: requirement.txt)
pip install -r requirement.txt --index-url [https://download.pytorch.org/whl/cu118](https://download.pytorch.org/whl/cu118)
...
├── download.bash                          # Script to pull required Hugging Face model weights
├── process_V77_GOLD.py                    # Ultimate heuristic logic version (Recommended Main Script)
├── process_pipeline.py                    # Standard execution script and pipeline helpers
├── requirement.txt                        # Project dependencies
├── 01_kapital_29_09_25_V77_FINAL_GOLD.txt # Final formatted output (located in root directory)
├── 02tarm011225_V4_FINAL.txt              # Additional final output (located in root directory)
